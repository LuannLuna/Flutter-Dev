            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text("R\$ ${cartProduct.productData.price.toStringAsFixed(2)}", style: TextStyle(color: Theme.of(context).primaryColor, fontWeight: FontWeight.bold, fontSize: 16.0),),
                  Row(
                    ...
                    children: <Widget>[
                      ...
                      FlatButton(child: Text("Remover"), color: Colors.grey[500], onPressed: (){
